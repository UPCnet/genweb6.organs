...
def customBuildFolderTree(context, obj=None, query={}, strategy=NavtreeStrategyBase()):
    ...
    # CAMBIOS AÑADIDOS: revisamos los permisos de genweb.organs.organgovern
    # para mostrar o no estos en la navegación
    ...
    for r in results:
        if nav_settings.show_excluded_items or (not nav_settings.show_excluded_items and not r.exclude_from_nav):
