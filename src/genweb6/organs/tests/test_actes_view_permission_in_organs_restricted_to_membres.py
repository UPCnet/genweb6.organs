# -*- coding: utf-8 -*-
"""Tests de permisos de actas en órganos restringidos a miembros.

Basado en: https://serveistic.upc.edu/ca/organs-de-govern/documentacio/permisos-organ-restringit-a-membres

PERMISOS DE ACTAS, AUDIOS y ANNEX en órganos restricted_to_members_organ:
...
class OrgansMembresActesFunctionalTestCase(unittest.TestCase):
    """Tests funcionales para actas en órganos restringidos a miembros."""
    ...
    def setUp(self):
        ...
        # Create Restricted to Members Organ structure
        ...
        organ.acronim = 'OG.MEMBRES'
        organ.organType = 'restricted_to_members_organ'
    ...
    def test_organ_membres_view_actes_as_secretari(self):
        """Test permisos de OG1-Secretari sobre actas en órgano membres."""
        print("\n✅ Verificando permisos del rol OG1-Secretari en órgano membres")

        logout()
        root_path = self.portal.ca.testingfolder.membres
        ...
        self.assertTrue(
            DisplayFile(root_path.convocada.acta.audio, request).publishTraverse(
                request, 'file')())
        self.assertTrue(
            Download(root_path.convocada.acta.audio, request).publishTraverse(
                request, 'file')())
        print("  ✓ Acceso correcto a actas en sesión CONVOCADA")

        # START check sessio REALITZADA
        print("  ✓ Verificando acceso en sesión REALITZADA")
        ...
        self.assertTrue(
            DisplayFile(root_path.realitzada.acta.audio, request).publishTraverse(
                request, 'file')())
        self.assertTrue(
            Download(root_path.realitzada.acta.audio, request).publishTraverse(
                request, 'file')())
        print("  ✓ Acceso correcto a actas en sesión REALITZADA")

        # START check sessio TANCADA
        print("  ✓ Verificando acceso en sesión TANCADA")
        ...
        self.assertTrue(
            Download(root_path.tancada.acta, request).publishTraverse(
                request, 'file')())
        self.assertTrue(
            root_path.tancada.acta.audio.restrictedTraverse('view')())
        self.assertTrue(
            DisplayFile(root_path.tancada.acta.audio, request).publishTraverse(
                request, 'file')())
        self.assertTrue(
        ...
        print("  ✓ Verificando acceso en sesión EN CORRECCIO")
        ...
        self.assertTrue(
            DisplayFile(root_path.correccio.acta.audio, request).publishTraverse(
                request, 'file')())
        self.assertTrue(
            Download(root_path.correccio.acta.audio, request).publishTraverse(
                request, 'file')())
    ...
    def test_organ_membres_view_actes_as_editor(self):
        """Test permisos de OG2-Editor sobre actas en órgano membres."""
    ...
    def test_organ_membres_view_actes_as_membre(self):
        """Test permisos de OG3-Membre sobre actas en órgano membres."""
        ...
        # START check sessio CONVOCADA - Tiene acceso
        ...
        # START check sessio REALITZADA - Tiene acceso
        print("  ✓ Verificando acceso permitido en sesión REALITZADA")
        self.assertTrue(root_path.realitzada.restrictedTraverse('view')())
        self.assertTrue(root_path.realitzada.acta.restrictedTraverse('view')())
        self.assertTrue(
            DisplayFile(root_path.realitzada.acta, request).publishTraverse(
        ...
        self.assertTrue(
            Download(root_path.realitzada.acta.audio, request).publishTraverse(
                request, 'file')())
        print("  ✓ Acceso permitido en sesión REALITZADA")

        # START check sessio TANCADA - Tiene acceso
        print("  ✓ Verificando acceso permitido en sesión TANCADA")
        self.assertTrue(root_path.tancada.restrictedTraverse('view')())
        self.assertTrue(root_path.tancada.acta.restrictedTraverse('view')())
        self.assertTrue(
            DisplayFile(root_path.tancada.acta, request).publishTraverse(
        ...
        self.assertTrue(
            Download(root_path.tancada.acta.audio, request).publishTraverse(
                request, 'file')())
        print("  ✓ Acceso permitido en sesión TANCADA")

        # START check sessio EN CORRECCIO - Tiene acceso
        print("  ✓ Verificando acceso permitido en sesión EN CORRECCIO")
        self.assertTrue(root_path.correccio.restrictedTraverse('view')())
        self.assertTrue(root_path.correccio.acta.restrictedTraverse('view')())
        self.assertTrue(
            DisplayFile(root_path.correccio.acta, request).publishTraverse(
        ...
        self.assertTrue(
            Download(root_path.correccio.acta.audio, request).publishTraverse(
                request, 'file')())
        print("  ✓ Acceso permitido en sesión EN CORRECCIO")

        print("  ✓ Verificación completa como OG3-Membre")
        logout()

    def test_organ_membres_view_actes_as_afectat(self):
        """Test restricciones de OG4-Afectat sobre actas en órgano membres."""
        ...
        # OG4-Afectat NO tiene acceso en ningún estado en órganos membres
        for session_state in [
            ...
            print(
                f"  ✓ Acceso denegado correctamente en sesión {session_state.upper()}")

        print("  ✓ Verificación completa como OG4-Afectat (sin acceso en ningún estado)")
        logout()

    def test_organ_membres_view_actes_as_convidat(self):
        """Test permisos de OG5-Convidat sobre actas en órgano membres."""
